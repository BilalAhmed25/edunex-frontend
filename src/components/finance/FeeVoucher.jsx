...
const FeeVoucher = ({ voucher, copyTitle = "Office Copy" }) => {
    ...
    return (
        <div className="bg-white text-slate-900 poppins w-full sm:w-[794px] min-h-[374px] flex flex-col border border-dashed border-slate-300 mb-4 last:mb-0 print:border-solid print:rounded-none print:shadow-none print:mb-0 print:w-[210mm] print:min-h-[99mm] print:border-b-2">
            {/* Branding Header */}
