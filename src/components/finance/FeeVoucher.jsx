...
const FeeVoucher = ({ voucher, copyTitle = "Office Copy" }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 poppins w-[794px] min-h-[374px] flex flex-col border border-dashed border-slate-300 dark:border-slate-800 mb-4 last:mb-0 print:border-solid print:rounded-none print:shadow-none print:mb-0">
            {/* Branding Header */}
            <ReportHeader className="bg-slate-50/50 dark:bg-slate-900/50 p-3" />

            {/* Sub Header / Voucher Type */}
            <div className="flex justify-between items-center px-6 py-2 bg-white dark:bg-slate-950">
            ...
            <div className="px-6 py-2 flex gap-6">
                {/* Student Info */}
                <div className="w-[35%] space-y-5 border-r border-slate-200 dark:border-slate-800 pr-6">
                    <div>
                    ...
                    <div className="space-y-3.5">
                        <div className="flex flex-col border-t border-slate-200 dark:border-slate-800 pt-2">
                ...
                <div className="flex-1 flex flex-col">
                    <div className="mb-2">
                        <table className="w-full text-[11px] border-collapse">
                            <thead className="bg-slate-50 dark:bg-slate-900 border-b dark:border-slate-800 sticky top-0">
                                <tr>
                    ...
                    {/* Totals */}
                    <div className="pt-2 border-t-2 border-slate-200 dark:border-slate-800 space-y-1">
                        ...
                        <div className="flex justify-between items-center pt-2 mt-1 border-t border-dashed dark:border-slate-800">
            ...
            {/* Footer Notice */}
            <div className="px-6 py-2 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 text-center">
